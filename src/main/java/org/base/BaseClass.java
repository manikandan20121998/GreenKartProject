...
//base class la ( main method and sysout ) eruka kudathu
...
//	}
	...
	public static boolean waitforurl(String url,long sec) {
	...
	public static void screenshotwithbyte(Scenario sc) {
		TakesScreenshot tk=(TakesScreenshot)driver;
		byte[] bt = tk.getScreenshotAs(OutputType.BYTES);
		sc.embed(bt, "image/png");
	}
	
	public static void screenshotwithfile(Scenario sc) throws IOException {
